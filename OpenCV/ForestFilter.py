...
upper_red1 = np.array([50, 255, 186])
lower_red2 = np.array([0, 111, 0])
upper_red2 = np.array([31, 225, 186])
...
red_mask_open = cv2.morphologyEx(red_mask, cv2.MORPH_OPEN, (5,5))
